...
考虑连续的对称多人一般乐透博弈，其由$(k\geq2,n,\vec{\mathcal{B}}=1,\vec{v})$指定。当玩家$i$在战场$j$上的分布为$\mathcal{D}_{i,j}=\frac{kv_j}{V}\cdot Beta(\frac{1}{k-1},1)$时，是一个纳什均衡。

### 多人上校博弈均衡算法

基于多人一般乐透博弈的该均衡，文章考虑对称的上校博弈。假如对战场有一个k-分区使得各个分区中战场价值总和相同，那么玩家可以根据特定算法达到纳什均衡。
