...
方便起见，记$U(t)=U(t;t)$。令$\phi(w)=\min_x\mathbb{E}_v[x(v,t)]\text{s.t. }\mathbb{E}_v[v\cdot x(v,t)]=w$表示能向买方提供预期价值$w$的最低预期分配。文章将收入最大化的问题视作一个优化问题，其中$U(T)$为唯一的决定性变量。由于关于IC-t的表述是充要的，因而最大化的方程可以写作：
...
![picture](_media/PaperReading-202309-20230920/picture-2.png)
