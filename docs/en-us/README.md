...
Besides, a [sub-site](https://pikapikapikaori.github.io/pikapikapi-blog-hexo/) of this blog is also deployed, which is powered by [Hexo](https://hexo.io/). You can preview the sub-site below:
